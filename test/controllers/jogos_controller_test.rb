...
class JogosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create jogo" do
    assert_difference('Jogo.count') do
      post jogos_url, params: { jogo: { estilo: @jogo.estilo, nome: @jogo.nome, preco: @jogo.preco, produtora: @jogo.produtora } }
    end
  ...
  test "should update jogo" do
    patch jogo_url(@jogo), params: { jogo: { estilo: @jogo.estilo, nome: @jogo.nome, preco: @jogo.preco, produtora: @jogo.produtora } }
